...
- `scr/`  
  ...
  - `11_build_table_vs_lastyear.py` – build current-year vs prior-year summaries + Excel (`output/table_vs_lastyear.xlsx`).  
  - `12_build_table_vs_history.py` – build multi-year comparison table + Excel (`output/table_vs_history.xlsx`).  
  - `13_build_table_vs_avg_gfc.py` – build CCAR vs Avg vs GFC table with heatmap (`output/table_vs_avg_gfc.xlsx`).
